...
function Snowman({
  ...
  /** restartGame: creates new Snowman state */
  ...
  /** restartButton: return button to restart game */
  ...
  return (
      <div className="Snowman">
        ...
        {nWrong === maxWrong && <p>YOU LOSE<br/>Word is: {answer}</p>}
        <div className="Snowman-restart">{restartButton()}</div>
      </div>
  );
}
